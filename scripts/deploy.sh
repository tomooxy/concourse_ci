...
printenv
scp -oStrictHostKeyChecking=no -i kantan_pipeline_resource/key kantan_resource/kantanPro/target/kantanPro-0.0.1-SNAPSHOT.jar vagrant@192.168.33.10:/home/vagrant/concourse/module/
