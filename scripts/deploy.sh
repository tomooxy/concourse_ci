...
printenv
scp -p 2200 -i kantan_pipeline_resource/key kantan_resource/kantanPro/target/kantanPro-0.0.1-SNAPSHOT.jar vagrant@127.0.0.1:/home/vagrant/concourse/module/
